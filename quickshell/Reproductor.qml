    ...
    Rectangle {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                radius: 5
                border.width: 3
                border.color: Qt.alpha("#a6c8ff", 0.7)
                color: "transparent"
                clip: true
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Button {
                        ...
                        contentItem: Text { text: parent.text; color: Qt.alpha("#e1e2e9", 0.9); font.pixelSize: 25; font.family: "SF Pro Display" }
                    }
                    ...
                    Button {
                        ...
                        contentItem: Text { text: parent.text; color: Qt.alpha("#a6c8ff", 0.9); font.pixelSize: 25; font.family: "SF Pro Display" }
                    }
                ...
                RowLayout {
                    ...
                    Slider {
                        ...
                        background: Rectangle {
                            ...
                            height: 4
                            radius: 2
                            color: Qt.alpha("#a6c8ff", 0.2)

                            Rectangle {
                                width: progressSlider.visualPosition * parent.width
                                height: parent.height
                                color: Qt.alpha("#a6c8ff", 0.8)
                                radius: 2
                            }
                        }
